    ...
    <body>
                    ...
                    <div class="d-flex">
                        <div class="sb2-2-2">
                            <ul>
                                ...
                                <li class="active-bre"><a> PO List</a></li>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-sm-6 mob-hide" style="padding-right: 3rem">
                                                    <form class="app-search">
                                                        ...
                                                        <input type="text" placeholder="Search..." id="search" onkeyup="searchPO()" name="keySearch" value="${key}" oninput="searchPO()">
                                                ...
                                                <table id="" class="table table-hover" style="width:100%">
                                                    ...
                                                    <tbody>
                                                        <c:forEach items="${list}" var="po">
                                                            <tr>
                                                                <td>${po.poid}</td>
                                                                <td>${custom.getCurriculumCodeByPOID(po.poid)}</td>

                                                                <td>
                                                                    <a href="#">
                                                                        <span class="list-enq-name">${po.poName}</span>
                                                                    </a>
                                                                </td>
                                                                <td>${po.poDescription}</td>
                                                                <td>
                                                                    <a href="poDetail?poid=${po.poid}" class="ad-st-view">View</a>
        ...
        <script>
                                                                ...
                                                                function changePage(page, sort) {
                                                                    let key = document.getElementById("search").value;
                                                                    let url = './poList?keySearch=' + key + "&sort=" + sort + "&page=" + page;
                                                                ...
                                                                function sortByType(type) {
                                                                    let key = document.getElementById("search").value;
                                                                    let url = './poList?keySearch=' + key + "&sort=" + type;
