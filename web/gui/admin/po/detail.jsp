            ...
            <div class="row">
                ...
                <div class="sb2-2">
                    ...
                    <div class="float-right">
                        <a href="poAdd"><button class="btn btn-warning">Add PO</button></a>
                    </div>
                                                ...
                                                <div class="box-inn-sp">
                                                    ...
                                                    <div class="bor">
                                                        <form action="" method="post">               
                                                            <input type="text" name="poid" value="${po.poid}${poid != null ? poid : ''}" hidden>
                                                            <input type="text" name="type" value="update" hidden>
                                                            <div class="row">
                                                                <div class="input-field col s6">
                                                                    <input id="id" type="text" value="${po.poid}" class="validate" disabled="">
                                                                    <label for="id" class="">PO ID</label>
                                                                </div>
                                                                <div class="input-field col s6">
                                                                    <input id="name" name="name" type="text" value="${po.poName}${name != null ? name : ''}" class="validate" required>
                                                                    <label for="name" class="">PO Name <span class="text-danger">*</span></label>
                                                                    ${requestScope.errorUpdate}
                                                                    <c:if test="${requestScope.errorUpdate != null}">
                                                                        <span>${requestScope.errorUpdate}</span>
                                                                    </c:if>
                                                                </div>
                                                            </div>
                                                            <div class="row" style="margin-top: 2rem">
                                                                <div class="input-field col s12">
                                                                    <input type="radio" id="isActive" name="isActive" ${po.isActive ? 'checked': ''}${isActive != null ? isActive ? 'checked' : '' : ''} value="true" class="validate">
                                                                    <label for="isActive">isActive</label>
                                                                    <input type="radio" id="deActive" name="isActive" ${po.isActive ? '': 'checked'}${isActive != null ? isActive ? '' : 'checked' : ''} value="false" class="validate">
                                                            ...
                                                            <div class="row">
                                                                <div class="input-field col s12">
                                                                    <textarea cols="10" id="description" name="description" rows="10">${po.poDescription}${description != null ? description : ''}</textarea>
