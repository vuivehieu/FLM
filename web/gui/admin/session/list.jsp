    ...
    <body>
                    ...
                    <div class="d-flex">
                        <div class="sb2-2-2">
                            <ul>
                                ...
                                <li class="active-bre"><a> Session List</a></li>
                            </ul>
                        </div>
                        <div class="float-right">
                            <a href="sessionDetail?type=add"><button class="btn btn-warning">Add Session</button></a>
                        </div>
                    </div>
                                                ...
                                                <table id="" class="table table-hover" style="width:100%">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th width="40%" onclick="sortByType('${sort == "" ? 'code_down' : sort eq 'code_up' ? 'code_down': 'code_up'}')">Topic <span class="fa ${sort == "" ? 'fa-angle-up' : sort eq 'code_up' ? 'fa-angle-up' : 'fa-angle-down'}"></span></th>
                                                            <th onclick="sortByType('${sort == "" ? 'name_down' : sort eq 'name_up' ? 'name_down': 'name_up'}')">TeachingLearning-Type <span class="fa ${sort == "" ? 'fa-angle-up' : sort eq 'name_up' ? 'fa-angle-up' : 'fa-angle-down'}"></span></th>
                                                            <th >Author</th>
                                                            <th>Active</th>
                                                            <th></th>
                                                        </tr>
        ...
        <script>
                                                                ...
                                                                function searchSyllabus() {
                                                                    ...
                                                                    let url = './sessionList?keySearch=' + key;
                                                                ...
                                                                function changePage(page, sort) {
                                                                    let key = document.getElementById("search").value;
                                                                    let url = './sessionList?keySearch=' + key + "&sort=" + sort + "&page=" + page;
                                                                ...
                                                                function sortByType(type) {
                                                                    let key = document.getElementById("search").value;
                                                                    let url = './sessionList?keySearch=' + key + "&sort=" + type;
