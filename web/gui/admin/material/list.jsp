    ...
    <body>
                    ...
                    <div class="d-flex">
                        <div class="sb2-2-2">
                            <ul>
                                ...
                                <li class="active-bre"><a> Material List</a></li>
                            </ul>
                        </div>
                        <div class="float-right">
                            <a href="materialDetail?type=add"><button class="btn btn-warning">Add Material</button></a>
                        </div>
                    </div>
                                        ...
                                        <div class="table-responsive table-desi">
                                            ...
                                            <div id="root">
                                                <table id="" class="table table-hover" style="width:100%">
                                                    <thead>
                                                        <tr>
                                                            <th onclick="sortByType('${sort == "" ? 'id_down' : sort eq 'id_up' ? 'id_down': 'id_up'}')" width="10%" >MID <span class="fa ${sort == "" ? 'fa-angle-up' : sort eq 'id_up' ? 'fa-angle-up' : 'fa-angle-down'}"></span></th>
                                                            <th onclick="sortByType('${sort == "" ? 'author_down' : sort eq 'author_up' ? 'author_down': 'author_up'}')">Author <span class="fa ${sort == "" ? 'fa-angle-up' : sort eq 'author_up' ? 'fa-angle-up' : 'fa-angle-down'}"></span></th>                                                   
                                                            <th onclick="sortByType('${sort == "" ? 'publisher_down' : sort eq 'publisher_up' ? 'publisher_down': 'publisher_up'}')">Publisher <span class="fa ${sort == "" ? 'fa-angle-up' : sort eq 'publisher_up' ? 'fa-angle-up' : 'fa-angle-down'}"></span></th>
                                                            <th>Action</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <c:forEach items="${list}" var="item">
                                                            <tr>
                                                                ...
                                                                <td><a href="materialDetail?mid=${item.mid}">Edit</a></td>
                                                            </tr>
                                                        </c:forEach>
                                                    </tbody>
                                                </table>                                                
        ...
        <script>
                                                                ...
                                                                function searchSyllabus() {
                                                                    ...
                                                                    let url = './materialList?keySearch=' + key;
                                                                ...
                                                                function changePage(page, sort) {
                                                                    let key = document.getElementById("search").value;
                                                                    let url = './materialList?keySearch=' + key + "&sort=" + sort + "&page=" + page;
                                                                ...
                                                                function sortByType(type) {
                                                                    let key = document.getElementById("search").value;
                                                                    let url = './materialList?keySearch=' + key + "&sort=" + type;
