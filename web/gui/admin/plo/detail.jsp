...
<!--                                                                <div class="input-field col s6">
                                                                    <input id="id" type="text" value="${plo.ploid}" class="validate" disabled="">
                                                                    <label for="id" class="">PLO ID</label>
                                                                </div>-->
                                                                <div class="input-field col s6">
                                                                    <input id="name" name="name" type="text" value="${plo.ploName}${name != null ? name : ''}" class="validate" required>
                                                                    <label for="name" class="">PLO Name <span class="text-danger">*</span></label>
                                                            ...
                                                            <div class="row" style="margin-top: 2rem">
                                                                <div class="input-field col s12">
                                                                    <input type="radio" id="isActive" name="isActive" ${plo.isActive ? 'checked': ''}${isActive != null ? isActive ? 'checked' : '' : ''} value="true" class="validate">
                                                                    <label for="isActive">isActive</label>
                                                                    <input type="radio" id="deActive" name="isActive" ${plo.isActive ? '': 'checked'}${isActive != null ? isActive ? '' : 'checked' : ''} value="false" class="validate">
                                                            ...
                                                            <div class="row">
                                                                <div class="input-field col s12">
                                                                    <textarea cols="10" id="description" name="description" rows="10">${plo.ploDescription}${description != null ? description : ''}</textarea>
