                                                ...
                                                <tbody>
                                                    <c:forEach items="${curriculums}" var="item">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <span class="label ${item.isApproved == 0 ? 'label-danger' : 'label-success'}">
                                                                    ${item.isApproved == 0 ? 'Not Approved' :  'Approved'}</span>
                                                            </td>
                                                            <td>
                                                                <span class="label ${item.isActive == 0 ? 'label-danger' : 'label-success'}">
                                                                    ${item.isActive == 0 ? 'Inactive' : 'Active'}</span>
                                                            </td>
                                                            <td>
