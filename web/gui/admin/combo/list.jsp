    ...
    <body>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-sm-6 mob-hide" style="padding-right: 3rem">
                                                    <form class="app-search">
                                                        <input type="text" placeholder="Search..." id="search" name="keySearch" value="${key}" oninput="searchCombo()">
                                                ...
                                                <table id="" class="table table-hover" style="width:100%">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th onclick="sortByType('${sort == "" ? 'curCode_down' : sort eq 'curCode_up' ? 'curCode_down': 'curCode_up'}')">Cur Code <span class="fa ${sort == "" ? 'fa-angle-up' : sort eq 'curCode_up' ? 'fa-angle-up' : 'fa-angle-down'}"></span></th>
                                                            <th width="10%" onclick="sortByType('${sort == "" ? 'tag_down' : sort eq 'tag_up' ? 'tag_down': 'tag_up'}')">Combo Tag <span class="fa ${sort == "" ? 'fa-angle-up' : sort eq 'tag_up' ? 'fa-angle-up' : 'fa-angle-down'}"></span></th>
                                                            ...
                                                            <th width="7%">Status <span class="fa ${sort == "" ? 'fa-angle-up' : sort eq '' ? 'fa-angle-up' : 'fa-angle-down'}"></span></th>
                                                            <th></th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <c:forEach items="${list}" var="combo">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <span class="label ${combo.isActive ? 'label-success' : 'label-danger'}">${combo.isActive ? 'Active' : 'Block'}</span>
                                                                </td>
                                                                <td>
                                                                    <a href="comboDetail?cid=${combo.cid}" class="ad-st-view">View</a>
        ...
        <script>
                                                                ...
                                                                function searchCombo() {
                                                                    ...
                                                                    let url = './comboList?keySearch=' + key;
                                                                ...
                                                                function changePage(page, sort) {
                                                                    let key = document.getElementById("search").value;
                                                                    let url = './comboList?keySearch=' + key + "&sort=" + sort + "&page=" + page;
                                                                ...
                                                                function sortByType(type) {
                                                                    let key = document.getElementById("search").value;
                                                                    let url = './comboList?keySearch=' + key + "&sort=" + type;
