    ...
    <body>
                    ...
                    <div class="d-flex">
                        <div class="sb2-2-2">
                            <ul>
                                ...
                                <li class="active-bre"><a> Question List</a></li>
                            </ul>
                        </div>
                        <div class="float-right">
                            <a href="questionDetail?type=add"><button class="btn btn-warning">Add Question</button></a>
                        </div>
                    </div>
                                        ...
                                        <div class="table-responsive table-desi">
                                            ...
                                            <div id="root">
                                                <table id="" class="table table-hover" style="width:100%">
                                                    <thead>
                                                        <tr>
                                                            <th onclick="sortByType('${sort == "" ? 'id_down' : sort eq 'id_up' ? 'id_down': 'id_up'}')" width="10%" >QID <span class="fa ${sort == "" ? 'fa-angle-up' : sort eq 'id_up' ? 'fa-angle-up' : 'fa-angle-down'}"></span></th>
                                                            <th onclick="sortByType('${sort == "" ? 'sesid_down' : sort eq 'sesid_up' ? 'sesid_down': 'sesid_up'}')" width="10%" >SesID <span class="fa ${sort == "" ? 'fa-angle-up' : sort eq 'sesid_up' ? 'fa-angle-up' : 'fa-angle-down'}"></span></th>
                                                    ...
                                                    <tbody>
                                                        <c:forEach items="${list}" var="item">
                                                            <tr>
                                                                ...
                                                                <td><a href="questionDetail?qid=${item.qid}">Edit</a></td>
                                                            </tr>
                                                        </c:forEach>
                                                    </tbody>
                                                </table>                                                
        ...
        <script>
                                                                ...
                                                                function searchSyllabus() {
                                                                    ...
                                                                    let url = './questionList?keySearch=' + key;
                                                                ...
                                                                function changePage(page, sort) {
                                                                    let key = document.getElementById("search").value;
                                                                    let url = './questionList?keySearch=' + key + "&sort=" + sort + "&page=" + page;
                                                                ...
                                                                function sortByType(type) {
                                                                    let key = document.getElementById("search").value;
                                                                    let url = './questionList?keySearch=' + key + "&sort=" + type;
