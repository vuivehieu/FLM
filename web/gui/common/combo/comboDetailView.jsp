                                    ...
                                    <ul>
                                        <li>
                                            <div class="pg-eve-desc subject-details">
                                                <p>Combo Name: <span>${combo.tag} ${combo.comboName_EN} ${combo.comboName_VI}</span></p>
                                                <p>Note: <span>${combo.note}</span></p>
                                            ...
                                            <c:if test="${!combo.subject.isEmpty()}">
                                                <div class="table-responsive table-desi">
                                                    <table class="table table-hover">
                                                        ...
                                                        <tbody>
                                                            <c:forEach items="${combo.subject}" var="subject">
                                                                <tr>
                                                                    ...
                                                                    <td class=""><span class="list-enq-name">${subject.semester}</span></td>
